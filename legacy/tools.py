...
# Example usage:
#   python tools.py --env PROD --task showModuleInfo show_ds-profile show_us-profile show_spectrum get_sf get_eq show_rf_componenets get_wbfft get_ec show_fafe --settings amp_settings.json --mac '24:a1:86:1d:da:90' --ip 2001:558:6026:32:912b:2704:46eb:f4 --output 'test/get_eq'

#   python tools.py --env PROD --task get_wbfft get_ec show_fafe --settings amp_settings.json 24:a1:86:1d:da:90 --ip 2001:558:6026:32:912b:2704:46eb:f4
